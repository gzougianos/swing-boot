...
public class ClickCounterView extends JPanel {
	...
	@OnActionPerformed(value = IncreaseClickCounterCommand.class, id = "increase")
	...
	private IncreaseCounterParameter feedIncrease(ComponentEvent e) {
		System.out.println("parsource");
		return new IncreaseCounterParameter(this, 5);
	}
