...
import io.github.swingboot.control.installation.factory.OnMouseMovedInstallationFactory;

@Target({ FIELD, TYPE })
@Retention(RUNTIME)
@Documented
@DeclaresControlInstallation(factory = OnMouseMovedInstallationFactory.class, targetTypes = {
		Component.class })
