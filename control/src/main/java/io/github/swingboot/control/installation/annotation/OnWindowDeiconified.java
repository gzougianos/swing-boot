...
import io.github.swingboot.control.installation.factory.OnWindowDeiconifiedInstallationFactory;

@Target({ FIELD, TYPE })
@Retention(RUNTIME)
@Documented
@DeclaresControlInstallation(factory = OnWindowDeiconifiedInstallationFactory.class, targetTypes = {
		java.awt.Window.class })
public @interface OnWindowDeiconified {
