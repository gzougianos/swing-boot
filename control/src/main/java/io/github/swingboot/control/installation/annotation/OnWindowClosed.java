...
import io.github.swingboot.control.installation.factory.OnWindowClosedInstallationFactory;

@Target({ FIELD, TYPE })
@Retention(RUNTIME)
@Documented
@DeclaresControlInstallation(factory = OnWindowClosedInstallationFactory.class, targetTypes = {
