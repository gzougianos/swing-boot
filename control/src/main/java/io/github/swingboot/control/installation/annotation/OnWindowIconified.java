...
import io.github.swingboot.control.installation.factory.OnWindowIconifiedInstallationFactory;

@Target({ FIELD, TYPE })
@Retention(RUNTIME)
@Documented
@DeclaresControlInstallation(factory = OnWindowIconifiedInstallationFactory.class, targetTypes = {
