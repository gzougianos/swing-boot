...
import io.github.swingboot.control.installation.factory.OnMouseExitedInstallationFactory;

@Target({ FIELD, TYPE })
@Retention(RUNTIME)
@Documented
@DeclaresControlInstallation(factory = OnMouseExitedInstallationFactory.class, targetTypes = {
		Component.class })
public @interface OnMouseExited {
